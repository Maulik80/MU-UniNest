  ...
  const handleResumeAnalysis = async () => {
    ...
    try {
      ...
      const mockAnalysis = {
        ...
        summary: 'Good candidate with solid technical foundation. Strong in web development with room for growth in cloud technologies.'
      };
  ...
  const handleGetImprovements = async () => {
    ...
    try {
      ...
      const mockImprovements = {
        ...
        improvements: [
          {
            ...
            suggested: 'Dynamic professional summary highlighting key achievements',
        ...
        atsOptimization: ['Use standard section headers', 'Include more keywords'],
        keywordSuggestions: ['Machine Learning', 'API Development', 'Agile', 'Testing']
      };
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-uninest-navy mb-2">Student Dashboard</h1>
          <p className="text-uninest-gray">Manage your placement journey with AI-powered tools</p>
        </div>
            ...
            <CardContent className="p-6">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <p className="text-sm font-semibold text-green-600">{stats.placementStatus}</p>
                </div>
              </div>
            </CardContent>
          </Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium">Applied to TCS drive</p>
          ...
          <TabsContent value="resume" className="space-y-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>Upload your resume in PDF or DOC format (Max 5MB)</CardDescription>
              </CardHeader>
              <CardContent>
                ...
                {analysisResults && (
                  <div className="mt-6 space-y-4">
                    ...
                    <Card>
                      <CardContent className="p-6">
                        <div className="flex items-center justify-between mb-4">
                          <h4 className="text-lg font-medium">Compatibility Score</h4>
                          <Badge 
                            className={`text-lg px-3 py-1 ${
                              analysisResults.compatibilityScore >= 80 ? 'bg-green-100 text-green-800' :
                              analysisResults.compatibilityScore >= 60 ? 'bg-yellow-100 text-yellow-800' :
                        ...
                        <Progress value={analysisResults.compatibilityScore} className="mb-2" />
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <Card>
                        ...
                        <CardContent>
                          <div className="flex flex-wrap gap-2">
                            {analysisResults.keywordMatches.map((keyword, index) => (
                      ...
                      <Card>
                        <CardHeader>
                          <CardTitle className="text-base text-red-700">Missing Keywords</CardTitle>
                        </CardHeader>
                        <CardContent>
                          <div className="flex flex-wrap gap-2">
                ...
                {improvementSuggestions && (
                  <div className="mt-6 space-y-4">
                    ...
                    <Card>
                      ...
                      <CardContent>
                        <Progress value={improvementSuggestions.overallScore} className="mb-4" />
                        
                        <div className="space-y-4">
                          {improvementSuggestions.improvements.map((improvement, index) => (
                            <div key={index} className="border rounded-lg p-4">
                              <div className="flex items-center justify-between mb-2">
                                <h4 className="font-medium">{improvement.section}</h4>
                                <Badge 
                                  className={
                        ...
                        {improvementSuggestions.missingElements.length > 0 && (
                          <div className="mt-6">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {improvementSuggestions.missingElements.map((element, index) => (
                        ...
                        {improvementSuggestions.keywordSuggestions.length > 0 && (
                          <div className="mt-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {improvementSuggestions.keywordSuggestions.map((keyword, index) => (
          ...
          <TabsContent value="applications" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Track your placement drive applications</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                    ...
                    <div key={application.id} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-3">
                        <div>
                          ...
                          <p className="text-uninest-gray">{application.role}</p>
                        </div>
          ...
          <TabsContent value="offers" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Manage your job offers and responses</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-4">
                  {mockOffers.map((offer) => (
                    <div key={offer.id} className="border rounded-lg p-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-4 text-sm">
                        <div>
                          <span className="text-uninest-gray">Package: </span>
                          <span className="font-semibold text-lg">{offer.package}</span>
                        </div>
                        <div>
                  ...
                  {mockOffers.length === 0 && (
                    <div className="text-center py-8 text-gray-500">
                      ...
                      <p className="text-sm">Keep applying to get your dream job!</p>
                    </div>
                  )}
                </div>
              </CardContent>
